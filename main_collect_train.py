...
COORDINATION0 = './data/train/COORDINATION0.pkl'
COORDINATION1 = './data/train/COORDINATION1.pkl'
COORDINATION2 = './data/train/COORDINATION2.pkl'
COORDINATION3 = './data/train/COORDINATION3.pkl'
LABEL0 = './data/train/label0.pkl'
LABEL1 = './data/train/label1.pkl'
LABEL2 = './data/train/label2.pkl'
LABEL3 = './data/train/label3.pkl'
#IMAGES = './data/images/'
